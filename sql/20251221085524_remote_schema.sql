...
CREATE OR REPLACE FUNCTION "public"."count_payments"("p_search" "text" DEFAULT NULL::"text", "p_customer_id" "uuid" DEFAULT NULL::"uuid") RETURNS bigint
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
  search_pattern TEXT;
...
ALTER FUNCTION "public"."count_payments"("p_search" "text", "p_customer_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_booking_secure"("p_customer_id" "uuid", "p_room_id" "uuid", "p_check_in" timestamp with time zone, "p_check_out" timestamp with time zone, "p_number_of_nights" integer, "p_total_amount" numeric, "p_total_guests" integer DEFAULT 1, "p_notes" "text" DEFAULT NULL::"text", "p_advance_payment" numeric DEFAULT 0) RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
declare
  v_booking_id uuid;
...
ALTER FUNCTION "public"."create_booking_secure"("p_customer_id" "uuid", "p_room_id" "uuid", "p_check_in" timestamp with time zone, "p_check_out" timestamp with time zone, "p_number_of_nights" integer, "p_total_amount" numeric, "p_total_guests" integer, "p_notes" "text", "p_advance_payment" numeric) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."search_payments"("p_search" "text" DEFAULT NULL::"text", "p_page" integer DEFAULT 1, "p_limit" integer DEFAULT 10, "p_customer_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("id" "uuid", "booking_id" "uuid", "amount" numeric, "payment_method" "public"."payment_method_enum", "payment_status" "public"."payment_status_enum", "paid_at" timestamp with time zone, "verified_at" timestamp with time zone, "refunded_at" timestamp with time zone, "created_at" timestamp with time zone, "updated_at" timestamp with time zone, "customers" "jsonb", "rooms" "jsonb")
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
  search_pattern TEXT;
BEGIN
  ...
  WHERE
    -- Filter theo customer_id (optional)
    (p_customer_id IS NULL OR b.customer_id = p_customer_id)
...
ALTER FUNCTION "public"."search_payments"("p_search" "text", "p_page" integer, "p_limit" integer, "p_customer_id" "uuid") OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."count_payments"("p_search" "text", "p_customer_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."count_payments"("p_search" "text", "p_customer_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."count_payments"("p_search" "text", "p_customer_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_booking_secure"("p_customer_id" "uuid", "p_room_id" "uuid", "p_check_in" timestamp with time zone, "p_check_out" timestamp with time zone, "p_number_of_nights" integer, "p_total_amount" numeric, "p_total_guests" integer, "p_notes" "text", "p_advance_payment" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."create_booking_secure"("p_customer_id" "uuid", "p_room_id" "uuid", "p_check_in" timestamp with time zone, "p_check_out" timestamp with time zone, "p_number_of_nights" integer, "p_total_amount" numeric, "p_total_guests" integer, "p_notes" "text", "p_advance_payment" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_booking_secure"("p_customer_id" "uuid", "p_room_id" "uuid", "p_check_in" timestamp with time zone, "p_check_out" timestamp with time zone, "p_number_of_nights" integer, "p_total_amount" numeric, "p_total_guests" integer, "p_notes" "text", "p_advance_payment" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_payments"("p_search" "text", "p_page" integer, "p_limit" integer, "p_customer_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."search_payments"("p_search" "text", "p_page" integer, "p_limit" integer, "p_customer_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_payments"("p_search" "text", "p_page" integer, "p_limit" integer, "p_customer_id" "uuid") TO "service_role";
